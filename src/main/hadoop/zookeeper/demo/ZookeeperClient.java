...
public class ZookeeperClient {
    ...
    public void testCreate() throws Exception{
        ...
        String create = zk.create("/java/java","hello java".getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.EPHEMERAL_SEQUENTIAL);
    ...
    public void testUpdate() throws Exception{
        ...
        zk.setData("/java","hello Java".getBytes(),-1);
        zk.close();
    }
